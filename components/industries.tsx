...
const industries = [
  ...
  },
  {
    ...
    description: "Accelerate research and clinical workflows with machine learning and predictive diagnostics.",
  },
  {
    id: 3,
    ...
    description: "Enhanced customer experience with AI recommendations, forecasting, and dynamic pricing strategies.",
  },
  {
    id: 4,
    name: "Manufacturing & Supply Chain",
    icon: "🏭",
    highlights: ["Predictive Maintenance", "Quality Assurance", "Supply Visibility"],
    description: "Optimize operations with AI-driven anomaly detection and autonomous decision-making systems.",
  },
  {
    id: 5,
    ...
    description: "Embed AI capabilities into your platform with intelligent APIs and automation layers.",
  },
  {
    id: 6,
    name: "Government & Public Sector",
    icon: "🏛️",
    highlights: ["Citizen Engagement", "Resource Optimization", "Policy Insights"],
    description: "Secure AI infrastructure for modernizing public services and data-driven governance.",
  },
]
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          <div className="inline-block mb-4 px-4 py-1 rounded-full border border-accent/30 bg-accent/5 glass">
            <p className="text-sm font-medium text-accent">Vertical Solutions</p>
          </div>
              ...
              <div className="relative">
                ...
                <div className="flex flex-wrap gap-2">
                  {industry.highlights.map((highlight, i) => (
                    <span key={i} className="inline-block text-xs px-2 py-1 rounded bg-accent/10 text-accent">
                      {highlight}
                    </span>
                  ))}
                </div>
        ...
        <div className="relative glass rounded-2xl p-8 md:p-12 border-accent/30 overflow-hidden">
          ...
          <div className="relative space-y-6">
            <div className="flex items-start gap-4">
              <div className="text-6xl">{activeIndustry.icon}</div>
              <div>
                <h3 className="text-3xl font-bold text-foreground">{activeIndustry.name}</h3>
                <p className="text-muted-foreground mt-2 text-lg leading-relaxed">{activeIndustry.description}</p>
              </div>
            </div>

            <div>
              <h4 className="text-sm font-semibold text-accent uppercase tracking-wider mb-3">Key Capabilities</h4>
